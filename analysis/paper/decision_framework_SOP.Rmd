...
Previous studies in southern California show that many burned reference sites have scores that return to pre-burned values in 1-2 years [@Rehn11]. Therefore, we recommend resampling ~2 years post burn.
...
1. Site is located within mapped estuarine region (https://map.dfg.ca.gov/metadata/ds2792.html) and at elevations close to sea level (e.g., <10 m).
1. Field notes or other local expertise suggesting bi-directional flows or dominance of halophytic vegetation (e.g., pickleweed, marsh cordgrass)[^*]
1. The sample is dominated by marine or brackish invertebrates, such as polychaete worms (such as Manayunkia, Ficopomatus, or Nereis)$^1$
1. Direct measurements of salinity at a sample site can provide an indication of relative tidal influence.  Note that tidal conditions vary daily and with precipitation patterns, so a single measure of salinity may not reflect the gradient of conditions at a site. 
