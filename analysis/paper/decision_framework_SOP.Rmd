...
Below is an example of retrieving stream gauge data using the USGS `dataRetrieval` package: 
...
png(here('analysis/figures/sgrflo.png'), height = 4, width = 7, family = 'serif', units = 'in', res = 300)
plot(X_00060_00003 ~ Date, type = 'l', data = discharge, ylab = 'Discharge (ft3/s)')
dev.off()
...
### Sample was taken outside of the typical index period
...
### Unusual settings where the CSCI is known to give low scores
...
### Inadequate GIS predictors for the CSCI
...
### Spatial data for the stream channel don't match the actual location on the landscape
...
## Evaluating ambigous taxa effects on CSCI scores
